...
For issues with CVE intelligence data (incorrect verdicts, wrong remediation steps, etc.), please use the [Intel Feedback issue template](https://github.com/emphereio/ovrse/issues/new?template=intel_feedback.md). These are not security vulnerabilities in OVRSE itself.
